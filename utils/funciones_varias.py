...
def create_plotly_charts(df_seleccionado):
    ...
    figs = []
    fig1 = px.line(df_seleccionado, x=df_seleccionado.index, y="Temperatura_Celsius", color="ubicacion",
                   color_discrete_map={"Habitación": "#3DDEE0", "Salón": "#E07B3D"},
                   labels={"Temperatura_Celsius": "Temperatura (Celsius)", "Registro_temporal": "Tiempo", "ubicacion": "Ubicación"})
